...
class ToolDelegate : AdapterDelegate<List<SkillItem>>() {
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder = EllipsizeTextViewHolder(parent)
    override fun isForViewType(items: List<SkillItem>, position: Int): Boolean = items[position] is SkillItem.UserToolItem
    ...
    override fun onBindViewHolder(
        ...
        holder.bind(items[position] as SkillItem.UserToolItem)
    }
}